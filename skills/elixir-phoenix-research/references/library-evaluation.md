...
When `$elixir-phoenix-research --library` or evaluating a Hex dependency,
...
Write to `.codex/research/{library-name}-evaluation.md`:
...
- "Plan the integration" -> `$elixir-phoenix-plan`
