...
| Type | Path |
|------|------|
| Plan | .codex/plans/{slug}/plan.md |
| Progress | .codex/plans/{slug}/progress.md |
| Review | .codex/plans/{slug}/reviews/{slug}-review.md |
...
- Progress file: .codex/plans/{slug}/progress.md
- Current state: WORKING
- Current phase: 2
- Current task: 3/4
- Last error: {error from progress file}

Continue with /phx:work .codex/plans/{slug}/plan.md
```
...
ls -t .codex/plans/*/progress.md | head -1

# Check state
grep "State:" .codex/plans/*/progress.md | head -1

# Resume
/phx:work .codex/plans/{slug}/plan.md
```
...
# Then resume
/phx:work .codex/plans/{slug}/plan.md --from {task-id}
```
...
```bash
# Create PR
gh pr create --title "feat: {feature}" --body "$(cat .codex/plans/{slug}/reviews/{slug}-review.md)"
