...
# Create directories
mkdir -p .codex/plans/${FEATURE_SLUG}/{research,reviews,summaries}
...
- Write `.codex/plans/{feature}/plan.md`
...
- Plan: .codex/plans/{feature}/plan.md
- Progress: .codex/plans/{feature}/progress.md
- Review: .codex/plans/{feature}/reviews/{feature}-review.md
