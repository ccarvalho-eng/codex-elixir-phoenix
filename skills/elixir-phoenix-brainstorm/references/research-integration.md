...
Write analysis to: .codex/plans/{slug}/research/codebase-scan.md
...
Update `.codex/plans/{slug}/interview.md` with research findings
...
### `.codex/plans/{slug}/research/codebase-scan.md`
...
### `.codex/plans/{slug}/research/external.md`
